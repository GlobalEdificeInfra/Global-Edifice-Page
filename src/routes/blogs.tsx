  ...
  return (
    <section className="bg-[#f8f4ed] pt-12 md:pt-16">
      <div className={`${pageContainerClass} max-w-[85%]`}>
        ...
        <div className="grid items-center gap-5 rounded-[2rem] border border-[#e7e7e7] bg-white p-4 md:grid-cols-2 md:gap-6 md:rounded-[3rem] md:p-4">
          ...
          <div className="px-2 py-2 md:px-4">
            <h3 className="text-[1.35rem] font-semibold leading-[1.55] text-[#292f36] md:text-[1.65rem]">
            ...
            <div className="mt-6">
              <Link
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-[#0f4157] text-white transition hover:bg-[#0c3446]"
              >
      ...
      <div className={`${pageContainerClass} max-w-[85%]`}>
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {currentPosts.map((post) => (
            <article
              key={post.slug}
              className="group rounded-[2rem] border border-[#e7e7e7] bg-white p-4 transition hover:bg-[#0f4157] hover:text-white md:rounded-[2.5rem] md:p-[17px]"
            >
              ...
              <div className="mt-3 flex items-center justify-between gap-4">
                ...
                <Link
                  ...
                  className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#0f4157] text-white transition hover:bg-white hover:text-[#0f4157]"
                >
                  <ArrowRight className="h-4 w-4" />
                </Link>
              </div>
