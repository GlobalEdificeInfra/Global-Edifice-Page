...
const oldFab = `{/* Floating Action Buttons */}
      <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
        ...
        <a
          ...
          className="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition hover:scale-105 self-end"
        >
          <svg
            viewBox="0 0 24 24"
...
const newFab = `{/* Left side Call action */}
      ...
      {/* Right side WhatsApp action (placed above chat widget usually at bottom-4) */}
